<script lang="ts">
    ...
    const hours = [ {index: 0, string: '8am'}, {index: 1, string: '9am'}, {index: 2, string: '10am'}, {index: 3, string: '11am'}, 
                    ...
                    {index: 28, string: '12pm'}, {index: 29, string: '1pm'}, {index: 30, string: '2pm'},];
    ...
    function updateTrackerTime() {
        ...
        let startDate = new Date(`January 23, 2023 08:00 GMT-08`);
...
<div class='schedule-container' on:loadstart={updateTrackerTime()} on:mouseup>
    ...
    <div class='content' id='schedule-content' on:click={(e) => console.log(e)}>
            {#each hours as hour}
